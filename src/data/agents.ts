...
export const PIPELINE_AGENTS: AgentInfo[] = [
  ...
  },
  {
    ...
    image: hestiaImg,
    status: 'idle',
    description: 'Hestia adiciona animações sofisticadas e micro-interações — Framer Motion para transições, Embla para carousels, ReactBits.dev para efeitos visuais premium.',
    tools: ['Framer Motion', 'Embla Carousel', 'ReactBits.dev', 'tailwindcss-animate', 'CSS Transitions'],
  },
  {
    id: 'ares',
    name: 'Ares',
  ...
  },
  {
    ...
    image: hadesImg,
    status: 'idle',
    description: 'Hades emerge das sombras para criar a Landing Page — hero section, seções de features, social proof e CTAs com visual premium e animações impactantes.',
    tools: ['React', 'Framer Motion', 'Embla Carousel', 'ReactBits.dev', 'TailwindCSS'],
  },
  {
    id: 'perseus',
    name: 'Perseus',
